                ...
                >
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                        ...
                        <Box sx={{ textAlign: 'right' }}>
                            <Typography variant="h6" sx={{ fontWeight: 800, color: 'var(--accent)', lineHeight: 1 }}>
                                {el.sum} ₽
                            </Typography>
                        </Box>
                    </Box>
                    ...
                    {totalOrderWeight > 0 && (
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2, pt: 1, borderTop: '1px solid var(--border-color)' }}>
